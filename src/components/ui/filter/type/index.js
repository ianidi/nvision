...
export const FilterType = ({ open, setState, style }) => {
    ...
    return (
        ...
        content={({ position, childRect, popoverRect }) => (
          <div className="popover__container">
            <div className="d-flex align-items-center justify-content-end">
              <div className="type__filter__clear">Очистить все</div>
            </div>
                ...
                guide.map((item, index) => {
                  ...
                  return (
                    <div key={index} className="d-flex justify-content-start">
                      <div className="d-flex align-items-center type__filter__row">
                        <Checkbox
      ...
      >
        <div className="type__dropdown" onClick={() => setState(!open)} style={{ ...style }}>
          <div>Тип удорстоверения</div>
          <IconArrowDown />
        </div>
      </Popover>
    );
